...
import type { Order, Trade, IndexPricePayloadStruct } from '../lib';
import type {
  Exchange_v1,
  Governance,
...
import type { MarketStruct } from '../typechain-types/contracts/Exchange_v1';
...
async function publishFundingRates(
  ...
  indexPriceAdapter: KatanaPerpsIndexAndOraclePriceAdapter,
