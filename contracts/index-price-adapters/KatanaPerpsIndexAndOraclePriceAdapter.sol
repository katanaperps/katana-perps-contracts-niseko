...
contract KatanaPerpsIndexAndOraclePriceAdapter is IIndexPriceAdapter, IOraclePriceAdapter, Owned {
  ...
  /**
   * @notice Instantiate a new `KatanaPerpsIndexAndOraclePriceAdapter` contract
   *
